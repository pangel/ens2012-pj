...
//        }
    ...
    public void setPlanes(Collection<Plane> planes) {
     ...
     public void setWeathers(Collection<Weather> weather) {
        this.mapPanel1.setWeathers(weather);
    }
    ...
    public void repaintStats() {
        this.crash_collision_label.setText(Integer.toString(Statistics.getNbCrashollision()));
        this.crash_weather_label.setText(Integer.toString(Statistics.getNbCrashSpeed()));
        this.crash_fuel_label.setText(Integer.toString(Statistics.getNbCrashFuel()));
        this.flight_duration_label.setText(Integer.toString((int)World.msToH(Statistics.getAverageTime())));
        this.landings_label.setText(Integer.toString(Statistics.getNbLanding()));
    }
    ...
    private void initComponents() {
        ...
        jSlider1 = new javax.swing.JSlider(1,30000,1000);
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        crash_collision_label = new javax.swing.JLabel();
        crash_fuel_label = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jLabel9 = new javax.swing.JLabel();
        jLabel10 = new javax.swing.JLabel();
        crash_weather_label = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        landings_label = new javax.swing.JLabel();
        flight_duration_label = new javax.swing.JLabel();
        ...
        jLabel2.setText("#Crashs");

        crash_collision_label.setText("0");

        crash_fuel_label.setText("0");

        jLabel8.setText("fuel");

        jLabel9.setText("collision");

        jLabel10.setText("météo");

        crash_weather_label.setText("0");

        jLabel3.setText("#Atterrissages");

        jLabel4.setText("Tps moy. de vol (h)");

        landings_label.setText("0");

        flight_duration_label.setText("0");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(crash_weather_label))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(crash_collision_label)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(flight_duration_label)
                        .addGap(72, 72, 72))))
        );
    ...
    private void jSlider1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSlider1StateChanged
        ...
        if (!source.getValueIsAdjusting()) {
            World.speedup = (double) source.getValue();
        }
    ...
    private javax.swing.JLabel crash_collision_label;
    private javax.swing.JLabel crash_fuel_label;
    private javax.swing.JLabel crash_weather_label;
    ...
    private javax.swing.JLabel flight_duration_label;
    ...
    private javax.swing.JLabel landings_label;
